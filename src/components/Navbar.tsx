...
export const Navbar = () => {
  ...
  return (
    <header
      dir={dir}
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 py-[5px] ${
        isScrolled
                        ...
                        <div className="py-2">
                          {link.categories.map((category) => (
                            ...
                            >
                              <a
                                href={category.href}
                                className={`flex items-center justify-between px-4 py-2.5 text-sm font-medium transition-all duration-200 mx-2 rounded-lg ${
                    ...
                    return (
                      ...
                      >
                        {link.isDropdown ? (
                          ...
                          <a
                            href={link.href}
                            className={`block py-3 px-5 font-semibold uppercase text-sm tracking-wide ${
                              isHome ? "text-white" : "text-foreground hover:bg-muted/40"
                            }`}
                            onClick={closeMobileMenu}
                          >
                            {link.name}
